...
def build_teams(
    ...
    """
    Build fastest relay teams for men's 4x50 medley.
...
def _find_fastest_medley_team(
    ...
    # Separate swimmers by their best stroke (for optimization)
    # But we need to try all combinations where each swimmer does their assigned stroke
    best_team = None
    best_time = float("inf")
